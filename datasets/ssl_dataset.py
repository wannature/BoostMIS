...
mean['covidx'] = [0.49507812, 0.49506304, 0.49511293]
mean['spinemets'] = [0.19374922,0.19374922,0.19374922]
std['covidx']=[0.24465941, 0.24465047, 0.24468097]
std['spinemets']=[0.14204098,0.14204098,0.14204098]
...
class ImagenetDataset(torchvision.datasets.ImageFolder):
    def __init__(self, root, transform, ulb, num_labels=-1):
        ...
        class_to_idx={'positive': 0,'negative': 1,}
        #spinemets
...
class ImageNetLoader:
    ...
    def get_transform(self, train, ulb):
        if train:
            transform = transforms.Compose([
                ...
                transforms.ToTensor(),
                transforms.Normalize(mean["covidx"], std["covidx"])])
        else:
            transform = transforms.Compose([
    ...
    def get_lb_test_data(self):
        ...
        data = ImagenetDataset(root=os.path.join(self.root_path, "test"), transform=transform, ulb=False)
        return data
